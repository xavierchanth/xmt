...
- If the shortcut is used without Accessibility access, Swapper shows a reminder once and suppresses further reminders until the Accessibility permission state changes.
